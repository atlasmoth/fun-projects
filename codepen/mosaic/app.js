document.addEventListener("DOMContentLoaded", function (e) {
  ...
  document.body.addEventListener("pointerdown", function (e) {
    ...
    if (
      typeof document
        ...
        .style.transform.split("rotateY(")[1] !== "undefined"
    ) {
      currentRotationY = parseFloat(
        document
          .getElementById("rotator")
          .style.transform.split("rotateY(")[1]
          .split(")")[0]
      );
    }
    if (
      typeof document
        .getElementById("rotator")
        .style.transform.split("rotateX(")[1] !== "undefined"
    ) {
      currentRotationX = parseFloat(
        document
          .getElementById("rotator")
          .style.transform.split("rotateX(")[1]
          .split(")")[0]
      );
    }
  });
  ...
  document.body.addEventListener("pointermove", function (e) {
    ...
    if (drag == true) {
      ...
      document.getElementById("rotator").style.transform = `rotateY(${
        changeY + currentRotationY
      }deg) rotateX(${-changeX + currentRotationX}deg)`;
    }
  });
});
